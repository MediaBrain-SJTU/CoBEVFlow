...
class IntermediateFusionDatasetAsync(basedataset.BaseDataset):
    ...
    def __init__(self, params, visualize, train=True):
        ...
        self.k = 1 # only one frame we need
        ...
        print("=== OPV2V-Irregular Single-sweep dataset with non-ego cavs' past {} frames collected initialized! Expectation of sample interval is {}. ### {} ###  samples totally! ===".format(self.k, self.binomial_n * self.binomial_p, self.len_record[-1]))
