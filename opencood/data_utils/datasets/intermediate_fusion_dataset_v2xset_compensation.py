...
from opencood.data_utils.datasets import basedataset, intermediate_fusion_dataset_v2xset
...
class IntermediateFusionDatasetV2XSETCompensation(intermediate_fusion_dataset_v2xset.IntermediateFusionDatasetV2XSET):
    """
    ...
    def __init__(self, params, visualize, train=True):
        super(IntermediateFusionDatasetV2XSETCompensation, self).__init__(params, visualize, train)
