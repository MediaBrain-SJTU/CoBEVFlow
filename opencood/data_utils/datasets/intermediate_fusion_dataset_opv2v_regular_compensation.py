...
class IntermediateFusionDatasetRegularCompensation(basedataset.BaseDataset):
    """
    ...
    def __init__(self, params, visualize, train=True):
        super(IntermediateFusionDatasetRegularCompensation, self).__init__(params, visualize, train)
