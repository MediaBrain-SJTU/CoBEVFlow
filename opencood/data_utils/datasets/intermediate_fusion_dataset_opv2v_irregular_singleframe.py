...
"""
为了给v2vnet 等baseline方法训练 用的数据集
有一些baseline方法需要使用多个车之间的pairwise_t_matrix 在多帧的数据集里面忽略了这点 该类将多车之间的坐标系变换补充好
"""
...
class IntermediateFusionDatasetIrregularSingleframe(basedataset.BaseDataset):
    """
    ...
    def __getitem__(self, idx):
        ...
        pairwise_t_matrix = \
            self.get_pairwise_transformation(base_data_dict, self.max_cav)
