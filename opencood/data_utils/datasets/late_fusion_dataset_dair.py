...
class LateFusionDatasetDAIR(late_fusion_dataset.LateFusionDataset):
    ...
    def retrieve_base_data(self, idx):
        ...
        data[0]['params']['vehicles'] = load_json(os.path.join('/GPFS/rhome/quanhaoli/workspace/dataset/my_dair_v2x/v2x_c/cooperative-vehicle-infrastructure/vehicle-side/label/lidar/',veh_frame_id + '.json'))
        ...
        data[1]['params']['vehicles'] = load_json(os.path.join('/GPFS/rhome/quanhaoli/workspace/dataset/my_dair_v2x/v2x_c/cooperative-vehicle-infrastructure/infrastructure-side/label/virtuallidar/',inf_frame_id + '.json'))
    ...
    def generate_object_center(self,
        ...
        return self.post_processor.generate_object_center_dairv2x_late(cav_contents,
                                                        reference_lidar_pose)
