...
'''
Use pre-trained late-fusioin model, 
'''
...
from opencood.models.fuse_modules.raindrop_attn_single_2_fused import raindrop_fuse
import torch

class PointPillarWhere2commSingle2Fused(nn.Module):
    def __init__(self, args):
        super(PointPillarWhere2commSingle2Fused, self).__init__()
        ...
        self.fusion_net = raindrop_fuse(args['fusion_args'])
        ...
        self.cls_head_fused = nn.Conv2d(int(dim), args['anchor_number'], kernel_size=1)
        self.reg_head_fused = nn.Conv2d(int(dim), 7 * args['anchor_number'], kernel_size=1)
    ...
    def forward(self, data_dict):
        ...
        output_dict['comm_rate'] = communication_rates
