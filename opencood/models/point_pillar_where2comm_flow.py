...
''' 
where2comm as backbone
use MotionNet to generate flow
use GT flow as supervision
''' 
...
class PointPillarWhere2commFlow(nn.Module):
    def __init__(self, args):
        super(PointPillarWhere2commFlow, self).__init__()
