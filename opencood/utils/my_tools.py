...
def irv2v_to_npy_and_json(split_name="train", root_path="/remote-home/share/V2XSET"):
    # 处理的数据集
    data_seperate_name = split_name
    # pcd 文件路径
    root_dir = root_path + data_seperate_name
    # yaml 文件路径
    # root_annotation_dir = "/GPFS/public/OPV2V_Irregular_V2/dataset_irregular_v2/" + data_seperate_name
    # 新保存的路径
    save_dir = root_path + "_npy/" + data_seperate_name
